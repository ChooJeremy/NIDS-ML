...
with session:
    ...
    history = model.fit(stacked_df, stacked_df, epochs=500, steps_per_epoch=(num_of_files//b_size)+1, verbose=1, validation_data=(val_stacked_df,val_stacked_df), validation_steps=(num_of_val_files* len(file_list)//b_size)+1)
