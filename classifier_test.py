...
#print (test_dataframe)
#train_mode = d.replace(-1, np.nan).mode()#.drop([1, 2])
#print (d.mode())
#raise
#raise
...
#print("Mean shape: ", d.mean(axis=0).shape)
#print("Mode", d.replace(-1, np.nan).mode())
#print("Mode shape:", d.mode().shape)
...
with session:
    ...
    results = classifier.evaluate(test_stacked_df, dy_test, verbose=1, steps=(1))
